  ...
  return (
    <div>
      <div className="relative w-full h-[705px] bg-black">
        ...
        <div className="absolute top-[15%] left-[10%] w-[80%] text-left text-6xl sm:text-2xl font-medium text-white animate-appear-text-left">
          <h1>Dê um check na sua produtividade</h1>
        </div>

        <div className="absolute top-[34%] sm:top-[25%] left-[20%] w-[60%] text-2xl sm:text-base text-white text-justify animate-appear-text-left">
          <p>
