...
export const Header = () => {
  ...
  const [aaaaaaaa, setAaaaaaaa] = useState("opacity-0");
  useEffect(() => {
    const aaa = () => setTeste("animate-bounce");
    const aaa1 = () => setTeste1("animate-bounce");
    setAaaaaaaa("opacity-100");
    setTimeout(aaa, 150);
    setTimeout(aaa1, 300);
  }, []);
  return (
    <>
      <div className="w-full flex bg-neutral-950 text-white h-24 items-center">
        <div
          className={`w-1/2 p-8 text-4xl font-medium flex duration-[8000ms]  ${aaaaaaaa}`}
        >
          <p className="animate-bounce">G</p>
          <p className={teste}>H</p>
          <p className={teste1}>B</p>
        </div>
