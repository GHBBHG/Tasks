...
export const Modal = ({ closeModal, children, isLoading }: ModalProps) => {
  const wait = () => {
    return alert("Espere um momento!");
  };
  ...
  return (
    <>
      <div
        ...
        onClick={!isLoading ? closeModal : wait}
      ></div>
      ...
      >
        ...
        {isLoading && (
          <div className="h-[80%] flex text-center justify-center items-center text-white">
            <div role="status">
              <svg
                aria-hidden="true"
